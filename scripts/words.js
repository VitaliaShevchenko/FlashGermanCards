...
export const wordsA2 = [
 ...
 export const wordsB1 = [
  ...
  new Word("gültig", "valid", "Diese Fahrkarte ist nicht mehr gültig."),
  new Word("historisch", "historical", "Wir besuchten ein historisches Museum."),
  new Word("das Holz", "wood", "Der Tisch ist aus Holz gemacht."),
  new Word("innen", "inside", "Es ist warm hier innen."),
  new Word("die Hütte", "hut", "Wir übernachteten in einer kleinen Hütte."),
  new Word("die Jacke", "jacket", "Zieh deine Jacke an, es ist kalt draußen."),
  new Word("die Jugend", "youth", "Die Jugend von heute ist sehr technikaffin."),
  new Word("das Kapitel", "chapter", "Ich habe das erste Kapitel des Buches gelesen."),
  new Word("der Käse", "cheese", "Ich hätte gerne ein Stück Käse."),
  new Word("knapp", "scarce, tight", "Die Zeit war knapp."),
  new Word("klug", "smart, clever", "Sie ist ein sehr kluges Mädchen."),
  new Word("der Kreis", "circle", "Wir standen in einem Kreis."),
  new Word("die Lage", "situation, location", "Die Lage ist ernst."),
  new Word("laut", "loud", "Das Radio ist zu laut."),
  new Word("das Lexikon", "encyclopedia", "Er liest im Lexikon nach."),
  new Word("die Luft", "air", "Die Luft hier ist frisch."),
  new Word("der Magen", "stomach", "Mein Magen tut weh."),
  new Word("locker", "loose, relaxed", "Die Schraube ist locker."),
  new Word("das Mehl", "flour", "Wir brauchen Mehl zum Backen."),
  new Word("mindestens", "at least", "Du musst mindestens acht Stunden schlafen."),
  new Word("der Moment", "moment", "Warte einen Moment bitte."),
  new Word("nachher", "afterwards", "Wir gehen nachher ins Kino."),
  new Word("nervös", "nervous", "Sie ist vor dem Test sehr nervös."),
  new Word("nett", "nice", "Er ist ein sehr netter Mensch."),
  new Word("die Nichte", "niece", "Meine Nichte ist fünf Jahre alt."),
  new Word("negativ", "negative", "Der Test war negativ."),
  new Word("nochmals", "again", "Können Sie das nochmals wiederholen?"),
  new Word("öffentlich", "public", "Der Park ist öffentlich zugänglich."),
  new Word("die Party", "party", "Die Party war großartig."),
  new Word("die Pflicht", "duty", "Es ist meine Pflicht, zu helfen."),
  new Word("prima", "great", "Das Essen war prima."),
  new Word("das Quiz", "quiz", "Wir haben ein Quiz in der Klasse gemacht."),
  new Word("rechtzeitig", "on time", "Wir müssen rechtzeitig ankommen."),
  new Word("reif", "mature, ripe", "Die Früchte sind reif."),
  new Word("der Respekt", "respect", "Er hat großen Respekt vor ihr."),
  new Word("der Saal", "hall", "Der Saal war voll."),
  new Word("sämtliche", "all", "Sämtliche Gäste sind eingeladen."),
  new Word("der Schatten", "shadow", "Der Baum wirft einen großen Schatten."),
  new Word("schützen", "to protect", "Wir müssen die Umwelt schützen."),
  new Word("sichtbar", "visible", "Der Turm ist von hier aus sichtbar."),
  new Word("sowieso", "anyway", "Es ist sowieso zu spät."),
  new Word("steil", "steep", "Der Weg ist sehr steil."),
  new Word("die Stimme", "voice", "Ihre Stimme ist wunderschön."),
  new Word("stumm", "mute", "Der Fernseher ist stumm geschaltet."),
  new Word("die Tastatur", "keyboard", "Die Tastatur funktioniert nicht."),
  new Word("überall", "everywhere", "Es gibt überall Blumen."),
  new Word("umgekehrt", "reversed", "Die Reihenfolge ist umgekehrt."),
  new Word("untersagt", "prohibited", "Rauchen ist hier untersagt."),
  new Word("der Verein", "club, association", "Ich bin Mitglied in einem Verein."),
  new Word("die Verspätung", "delay", "Der Zug hat Verspätung."),
  new Word("völlig", "completely", "Ich bin völlig erschöpft."),
  new Word("der Vorteil", "advantage", "Das ist ein großer Vorteil."),
  new Word("der Wert", "value", "Das hat für mich einen hohen Wert."),
  new Word("das Zeichen", "sign", "Das ist ein Zeichen des Friedens."),
  new Word("der Zettel", "note", "Ich habe einen Zettel auf dem Tisch gefunden."),
  new Word("zwischen", "between", "Der Stuhl steht zwischen dem Tisch und der Wand.")
];